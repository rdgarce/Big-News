...
def main():
    st.header('Trend Viewer :chart_with_upwards_trend:', divider='blue')
    st.markdown("""Il Trend Viewer consente di selezionare un'entità presente nel database e visualizzare l'andamento temporale delle citazioni negli articoli riferite ad essa a partire da Settembre 2022 fino ad oggi.""")
