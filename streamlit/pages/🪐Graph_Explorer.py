...
def main():
    ...
    st.markdown("""Il Graph Explorer consente di costruire dinamicamente un grafo selezionando un nodo radice, un intervallo temporale di pubblicazione delle notizie e un insieme di categorie di entità con cui si vogliono cercare le relazioni.
                    I nodi del grafo sono interattivi e sulle relazioni è possibile visualizzare la data ed il link dell'articolo originale da cui proviene l'informazione. Viene inoltre fornita una visualizzazione tabellare delle informazioni rappresentate nel grafo.
                """)
    ...
    if data:
        ...
        st.subheader("Triple estratte", divider='blue')
        st.dataframe(df)
